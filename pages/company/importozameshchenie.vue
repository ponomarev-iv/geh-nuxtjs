      ...
      .pp
        .c-wrap
          .pp__wrap
            article.pp__content
              p.pp__par
                | В&nbsp;настоящее время в&nbsp;АО&nbsp;&laquo;ГлобалЭнергоХолдинг&raquo; организована работа по&nbsp;привлечению промышленного потенциала регионов Российской Федерации к&nbsp;решению задач, направленных на&nbsp;импортозамещение продукции, применяемой или планируемой к&nbsp;применению в&nbsp;производственной деятельности АО&nbsp;&laquo;ГлобалЭнергоХолдинг&raquo;.
              .pp-info-block.mt_xl
                h2.pp-info-block__title
                  | Задачи, решаемые в&nbsp;рамках реализации программы импортозамещения АО&nbsp;&laquo;ГлобалЭнергоХолдинг&raquo;:
                IconBlock(
          ...
          p.pp__par
            | С&nbsp;целью оптимизации взаимодействия предприятий-изготовителей технологического оборудования и&nbsp;материалов с&nbsp;АО&nbsp;&laquo;ГлобалЭнергоХолдинг&raquo; и&nbsp;сопровождения разработки и&nbsp;освоения импортозамещающей продукции подготовлена форма опросного листа. Заполненный предприятием- изготовителем опросный лист вместе с&nbsp;сопроводительным письмом следует направлять в&nbsp;адрес Департамента материально-технического обеспечения АО&nbsp;&laquo;ГлобалЭнергоХолдинг&raquo;.
      .pp.mb_xl
        .c-wrap
        ...
        iconSet: [
          {
            ...
            txt: 'Снижение фактической зависимости от&nbsp;продукции импортного\n' +
              'производства, а&nbsp;также от&nbsp;предприятий производящих данную продукцию'
          },
          {
            icon: '/img/ico-safe.svg',
            txt: 'Полное исключение, либо минимизация ситуаций отсутствия\n' +
              'необходимых для реализации проектов, реализуемых\n' +
              'АО&nbsp;&laquo;ГлобалЭнергоХолдинг&raquo; товаров и&nbsp;оборудования или необоснованного\n' +
              'увеличения их&nbsp;стоимости, вызванного политическими рисками, резким\n' +
              'повышением спроса, задержками в&nbsp;доставке и&nbsp;таможенном\n' +
              'оформлении и&nbsp;т.д.'
          },
          {
            icon: '/img/ico-settings.svg',
            txt: 'Полное исключение, либо минимизация ситуаций простоя оборудования\n' +
              'или необоснованно высоких затрат на&nbsp;ремонт ввиду отсутствия запасных\n' +
              'частей и&nbsp;сервисной базы оборудования на&nbsp;территории Российской\n' +
              'Федерации'
          },
          {
            icon: '/img/ico-logistic.svg',
            txt: 'Оптимизация стоимости производства и&nbsp;сервиса продукции за&nbsp;счет\n' +
              'исключения транспортных расходов за&nbsp;пределами страны, таможенных\n' +
              'пошлин'
          },
          {
        ...
        docDownload: [
          {
            ...
            notes: 'xlsx, 56 Кб',
            url: 'forma-oprosnogo-lista.xlsx'
          },
          {
