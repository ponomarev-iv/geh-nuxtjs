<template lang="pug">
  nav.main-nav
    ...
    .main-nav__link-wrap
      router-link.main-nav__link.main-nav__link_drop(to="/in-dev#library") Библиотека
      .sub-menu
    ...
    .main-nav__link-wrap
      router-link.main-nav__link.main-nav__link_drop(to="/in-dev#press") Пресс-центр
      .sub-menu
    ...
    router-link.main-nav__link(to="/in-dev#akcii") Акции
